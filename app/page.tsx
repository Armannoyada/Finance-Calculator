...
const tools = [
  ...
  { title: 'Taxes & VAT', icon: ReceiptText, items: ['Income Tax','GST Calculator','VAT Calculator','Sales Tax Calculator','Capital Gains','Tax-inclusive Price','Tax-exclusive Price','Salary Tax'] },
  { title: 'Savings & Planning', icon: PiggyBank, items: ['Savings Goal','Retirement Planner','Inflation Calculator','Emergency Fund','Net Worth','Debt Payoff','Budget Planner','Currency Converter'] },
